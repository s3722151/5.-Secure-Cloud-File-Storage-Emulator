...
public class decryptFile 
{
	...
	public static String getFileName() 
	{
		...
		try 
		{
			if ((result ==JFileChooser.APPROVE_OPTION)) 
			{
				...
				System.out.println("The file that you are trying to retrieve and decrypt is:  " + filepath);
			}
	...
	{
	System.out.println("Select the file that you wish to decrypt.");
	String fileName;
    ...
    try {  
        File createObj = new File("cloud\\decrypted"+ fileName); //CHANGE this path based on where you saved it.  
    ...
    System.out.println("File: " +  fileName + " decrypted and uploaded successfully to the cloud.");
